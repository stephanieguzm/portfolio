...
export const About = () => {
  return (
    <section id={"about"} className={"flex flex-col w-full items-center justify-center px-4 text-gray-900 md:px-8"}>
      <div className={"flex-col w-full max-w-3xl items-center justify-center space-y-4 md:max-w-7xl md:justify-between md:space-y-0"}>
